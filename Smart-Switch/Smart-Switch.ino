...
const char* ssid     = "NEARMITECH"; //enter your ssid/ wi-fi(case sensitive) router name - 2.4 Ghz only
const char* password = "vyvx-ekps";     // enter ssid password (case sensitive)
